...
- Ability to load best XP or best money jobs preset or save your own jobs for later use or for automatic silver job swap when new day starts
...
- Enhanced consumable use: Intelligent calculation of best possible consumable to use in any given situation
- Automatically use best consumable (in specified range) every 10 minutes to refill energy
- Ability to travel to any job even locked ones when player has not enough LP or level to start the job
- Ability to work some jobs that are locked
- Automatically deposit specified amount of money in bank when player is not duel protected
- Ability to automatically use buffs for speed, xp, money, luck and product
- Feature to automatically build town
- Ability to save custom gear for each job
- Auto relog / auto refresh when needed
- Script will continue to work even after short internet cutoffs
- Script will automatically handle player KO or other unexpected events and will always work without getting stuck
...
- Script remembers all used consumables - how many consumables have been used and last used consumables
